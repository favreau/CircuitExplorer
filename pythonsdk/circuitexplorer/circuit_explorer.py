...
#
# This file is part of Brayns <https://github.com/favreau/CircuitExplorer>
#
...
class CircuitExplorer:
    ...
    def attach_vasculature_report(self, path, model_id, debug=False):
        params = dict()
        params['modelId'] = model_id
        params['path'] = path
        params['debug'] = debug
        return self._client.request(
            self.PLUGIN_API_PREFIX + 'attach-vasculature-report', params,
            response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)

    def apply_vasculature_geometry_report(self, path, model_id, frame, amplitude=1.0, debug=False):
        params = dict()
        params['modelId'] = model_id
        params['path'] = path
        params['frame'] = frame
        ...
        params['debug'] = debug
        return self._client.request(
            self.PLUGIN_API_PREFIX + 'apply-vasculature-geometry-report', params,
            response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def set_material(self, model_id, material_id, diffuse_color=(1.0, 1.0, 1.0),
        ...
        return self._client.request(self.PLUGIN_API_PREFIX + 'set-material', params=params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def set_materials(self, model_ids, material_ids, diffuse_colors, specular_colors,
        ...
        return self._client.request(self.PLUGIN_API_PREFIX + 'set-materials', params=params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def set_material_range(self, model_id, material_ids, diffuse_color=(1.0, 1.0, 1.0),
        ...
        params['clippingMode'] = clipping_mode
        params['userParameter'] = user_parameter
        return self._client.request(self.PLUGIN_API_PREFIX + 'set-material-range', params=params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def set_material_extra_attributes(self, model_id):
        ...
        params = dict()
        params['modelId'] = model_id
        return self._client.request(self.PLUGIN_API_PREFIX + 'set-material-extra-attributes', params=params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def set_camera(self, origin, direction, up):
        ...
        params['up'] = up
        return self._client.request(self.PLUGIN_API_PREFIX + 'set-odu-camera', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def get_camera(self):
        ...
        :rtype: str
        """
        return self._client.request(self.PLUGIN_API_PREFIX + 'get-odu-camera', response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def add_grid(self, min_value, max_value, interval, radius=1.0, opacity=0.5, show_axis=True,
        ...
        return self._client.request(self.PLUGIN_API_PREFIX + 'add-grid', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def add_column(self, radius=0.01):
        ...
        params = dict()
        params['radius'] = radius
        return self._client.request(self.PLUGIN_API_PREFIX + 'add-column', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def export_frames_to_disk(self, path, animation_frames, camera_definitions, image_format='png',
        ...
        return self._client.request(self.PLUGIN_API_PREFIX + 'export-frames-to-disk', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def get_export_frames_progress(self):
        ...
        return self._client.request(self.PLUGIN_API_PREFIX + 'get-export-frames-progress',
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def trace_anterograde(self, model_id, source_cells_gid, target_cells_gid, source_cells_color=(5, 5, 0, 1), target_cells_color=(5, 0, 0, 1), non_connected_color=(0.5, 0.5, 0.5, 1.0)):
        ...
        return self._client.request(self.PLUGIN_API_PREFIX + 'trace-anterograde', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def add_sphere(self, center, radius, color, name=""):
        ...
        params['color'] = color
        params['name'] = name
        return self._client.request(self.PLUGIN_API_PREFIX + 'add-sphere', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def add_pill(self, p1, p2, radius, color, name=""):
        ...
        params['color'] = color
        params['name'] = name
        return self._client.request(self.PLUGIN_API_PREFIX + 'add-pill', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def add_cylinder(self, center, up, radius, color, name=""):
        ...
        params['color'] = color
        params['name'] = name
        return self._client.request(self.PLUGIN_API_PREFIX + 'add-cylinder', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
    ...
    def add_box(self, minCorner, maxCorner, color, name=""):
        ...
        params['color'] = color
        params['name'] = name
        return self._client.request(self.PLUGIN_API_PREFIX + 'add-box', params,
                                    response_timeout=self.DEFAULT_RESPONSE_TIMEOUT)
